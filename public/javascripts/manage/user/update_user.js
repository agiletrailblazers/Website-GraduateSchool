...
$(document).ready(function () {
    ...
    $("#update-user-form-submit").click(function (event) {
        ...
        var oldEmail = $("#oldEmail").val().toLowerCase();
        var newEmail = $("#email").val().toLowerCase();

        if (newEmail && oldEmail && (oldEmail != newEmail)){
            $('#usernameConfirmModal').modal('show');
        } else {
            submitUpdateForm();
        }
    });

    $('#usernameChangeConfirm').click(function (e) {
        $('#usernameConfirmModal').modal('hide');
        submitUpdateForm();
    });

    $('#usernameChangeCancel').click(function (e) {
        $('#usernameConfirmModal').modal('hide');
    });
